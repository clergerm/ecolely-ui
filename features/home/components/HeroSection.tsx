...
export default function HeroSection() {
  return (
    <section className="w-full bg-gradient-to-b from-slate-100 to-slate-200 py-24">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-12 px-6 lg:flex-row">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="mt-6 max-w-xl text-lg text-gray-600">
            Ecolely helps students organize learning, connect knowledge, and
            achieve academic goals with modern technology.
          </p>
